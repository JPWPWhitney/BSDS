...
from . import asteroid_arrival, attitude_detumble, basic_orbit, drag_deorbit, ground_pointing, halo_orbit, hohmann, rendezvous
...
SCENARIOS = {
    ...
    ground_pointing.ID: ground_pointing,
    halo_orbit.ID: halo_orbit,
}
